...
export default function ProfessionModal({ onClose }) {
  return (
    <Modal onClick={() => onClose()}>
      ...
      <ModalContent onClick={(e) => e.stopPropagation()}>Profession</ModalContent>
      <ModalContent onClick={(e) => e.stopPropagation()}>Page</ModalContent>
    </Modal>
  );
}
